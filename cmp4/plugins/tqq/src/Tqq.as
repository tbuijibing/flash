package {
	...
	public class Tqq extends MovieClip {
		public var api:Object;
		public var tw:Number;
		public var th:Number;
		
		public var tqq_xywh:String = "20R,20,32,32";
		...
		private function apiHandler(e):void {
			...
			if (api.config.tqq_xywh) {
				tqq_xywh = api.config.tqq_xywh;
			}
		...
		private function resizeHandler(e:Event = null):void {
			...
			var arr:Array = api.tools.strings.xywh(tqq_xywh,tw,th);
