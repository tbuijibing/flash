package  {
	...
	public class P2PLive extends MovieClip {
		public function P2PLive():void {
		...
		private function apiHandler(e):void {
			...
			var p2plive:P2PLiveModel = new P2PLiveModel(apikey);
			var result:String = api.addModel(p2plive, "p2plive");
			//输出模块添加结果，看是否错误
