package  {
	...
	public class P2PStream extends MovieClip {
		public function P2PStream():void {
		...
		private function apiHandler(e):void {
			...
			var p2pstream:P2PStreamModel = new P2PStreamModel(apikey);
			var result:String = api.addModel(p2pstream, "p2pstream");
			//输出模块添加结果，看是否错误
